...
module.exports = {
  content: [
    ...
    './src/lib/**/*.{js,ts,jsx,tsx}', // Include utility files that might contain Tailwind classes
  ],
  darkMode: 'class',
  future: {
  ...
  theme: {
    extend: {
      ...
      boxShadow: {
        ...
        'tech-lg': '0 10px 15px -3px rgba(0, 0, 0, 0.05), 0 4px 6px -2px rgba(0, 0, 0, 0.03)',
        'tech-xl': '0 20px 25px -5px rgba(0, 0, 0, 0.08), 0 10px 10px -5px rgba(0, 0, 0, 0.04)',
      },
      animation: {
