...
export default function ContactContent({ content, profile, pageData }: ContactContentProps) {
  ...
  // Get content section data with fallbacks
  const connectSectionTitle = pageData?.connectSectionTitle || "Let's Connect";
  const connectSectionContent = pageData?.connectSectionContent || "I am always open to discussing new opportunities, collaborations, or just having a conversation about technology and development.";
  const formSectionTitle = pageData?.formSectionTitle || "Send Me a Message or Request Access";
